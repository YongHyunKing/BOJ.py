...
if __name__ == "__main__":
    ...
    if len(string1) < len(string2) : string1,string2 = string2, string1
    ...
    for i in range(n):
        ...
        if maax < k :
            if i < n1 and sa[group[i]+1] > n1:
                maax = k
                start_idx = sa[group[i]+1]
            elif i > n1 and sa[group[i]+1] < n1 :
                maax = k
                start_idx = i
        

    print(maax)
    print(string[start_idx:start_idx+maax])
